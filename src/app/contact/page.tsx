          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            >
              <Card className="rounded-[3rem] border-none shadow-2xl bg-white p-8 md:p-12">
                ...
                <form
                  action="https://formsubmit.co/labtasker@gmail.com"
                  method="POST"
                  className="space-y-6"
                >
                  <input type="hidden" name="_captcha" value="false" />
                  <input type="hidden" name="_subject" value="New Enquiry - Master Data Academy" />
                  ...
                  <Button
                    type="submit"
                    className="w-full h-16 rounded-2xl font-black text-lg shadow-xl shadow-primary/20 gradient-bg border-none hover:scale-[1.02] transition-transform"
                  >
